...
const postGeneratePreview = https.onCall(async (data, context) => {
  ...
  var definition = {
    ...
    content: [
      ...
      { text: 'Beaver County', style: vars.subHeader },
      {
        table: {
          widths: vars.grid,
          body: [
            ...
            [
              { text: data.metadata.status, style: vars.value },
              {
            ...
            [{ text: data.metadata.corner, style: vars.value }],
            [
              {
                ...
                table: {
                  ...
                  body: [
                    ...
                    [
                      ...
                      { text: data.geographic.elevation, style: vars.value },
                    ],
                    [
                      {
                        text: 'Unit',
                ...
                table: {
                  ...
                  body: [
                    ...
                    [
                      ...
                      { text: data.grid.elevation, style: vars.value },
                    ],
                    [
                      {
                        text: 'Units',
      ...
      },
      {
        ...
        table: {
          pageBreak: 'before',
          widths: [vars.half, vars.half],
          body: [
            [{ image: vars.additional }, { image: vars.additional }],
            [{ image: vars.additional }, { image: vars.additional }],
            [{ image: vars.additional }, { image: vars.additional }],
          ],
        },
