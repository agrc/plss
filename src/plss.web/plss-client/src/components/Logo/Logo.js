...
export default function Logo() {
  return (
    <div className="absolute z-10 flex flex-col items-center whitespace-no-wrap top-2 inset-x-1/2">
      <svg
        id="svg-logo"
      ...
      <div className="flex justify-center w-full text-sm font-bold text-center text-gray-800 whitespace-nowrap">
        Utah PLSS
      </div>
    </div>
  );
